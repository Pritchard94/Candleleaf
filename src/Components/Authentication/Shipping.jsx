...
const Shipping = () => {
  ...
  const validationSchema = Yup.object({
    ...
    shippingnote: Yup.string().optional('Optional')
  });

  const handleSubmit = (values) => {
    // Handle submit logic here, e.g. send form data to server
    console.log(values);
  };
    ...
    <div className='w-full'>
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        {(formik) => (
          <Form>
            <div>
              <input className='w-full border-[1px] outline-none border-[#56B280] p-2 mt-[12px]'
              ...
              <div className='flex items-center mt-[10px] space-x-2'>
                <input type='checkbox'/>
                <p className='text-[14px] text-[#272727]'>Add me to Candleaf newsletter for a 10% discount</p>
              </div>
            </div>

            <h1 className='text-[20px] text-[#272727] font-bold mb-[19px] mt-[30px]'>Shipping Details</h1>

            <div className='flex items-center w-full space-x-3'>
                    <div className='w-full'>
                        <label htmlFor="firstName"></label>
                        <Field name="lastName" type="text"className='border-[1px] outline-none w-full border-[#56B280] p-2'
            ...
            <div>
              ...
              <Field name="address" type="text" className='border-[1px] outline-none mt-[16px] w-full border-[#56B280] p-2' placeholder='Address' />
              <ErrorMessage name="address"className='text-[8px] ' />
            </div>
            <div>
              <label htmlFor="shippingnote"></label>
            ...
            <div>
              ...
              className='border-[1px] outline-none mt-[16px] pr-[10px] w-full border-[#56B280] p-2'
